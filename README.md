...
As an attempt to settle the underlying nebulous unease, primary anxiety screams to the conscious "X needs to change", where X is updated every time the prior X change is made and it's found the anxiety has persisted. This results in a perpetual and incredibly uncomfortable state of unrest, during which the anxiety appears to attach itself to every aspect of one's life (e.g. "maybe re-using this disposable water bottle is causing my daily nausea", "maybe I just need to clean the entire apartment", "maybe I just need to drop off that letter at the post office"). By the end of each day, this guessing game and the incessant journies that follow finally get to end with the most enjoyable activity of those with primary anixety: the turning off of ones's brain during sleep.
